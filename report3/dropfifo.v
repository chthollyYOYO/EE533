...
// /___/   /\     Timestamp : 02/01/2025 07:22:13
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/Desktop/lab4/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_6 (.A(XLXN_35[7:0]), 
                                  .B(XLXN_29[7:0]), 
                                  .EQ(XLXN_27));
   // synthesis attribute HU_SET of XLXI_6 is "XLXI_6_17"
   COMP8_MXILINX_dropfifo XLXI_8 (.A(XLXN_29[7:0]), 
                                  .B(XLXN_30[7:0]), 
                                  .EQ(XLXN_28));
   // synthesis attribute HU_SET of XLXI_8 is "XLXI_8_18"
   CB8CLE_MXILINX_dropfifo XLXI_9 (.C(clk), 
                                   ...
                                   .Q(XLXN_35[7:0]), 
                                   .TC());
   // synthesis attribute HU_SET of XLXI_9 is "XLXI_9_19"
   ...
   reg9B XLXI_12 (.ce(XLXN_41), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(XLXN_36[71:0]));
   AND3B2 XLXI_13 (.I0(XLXN_28), 
                   .I1(XLXN_27), 
                   .I2(fiforead), 
                   .O(XLXN_26));
   OR2 XLXI_14 (.I0(XLXN_4), 
                .I1(XLXN_3), 
                .O(XLXN_5));
   AND2B1 XLXI_15 (.I0(XLXN_9), 
                   .I1(XLXN_5), 
                   .O(XLXN_19));
   FD8CE_MXILINX_dropfifo XLXI_16 (.C(clk), 
                                   .CE(XLXN_19), 
                                   .CLR(rst), 
                                   .D(XLXN_35[7:0]), 
                                   .Q(XLXN_30[7:0]));
   // synthesis attribute HU_SET of XLXI_16 is "XLXI_16_21"
   VCC XLXI_17 (.P(XLXN_41));
   dual XLXI_18 (.addra(XLXN_35[7:0]), 
                 .addrb(XLXN_29[7:0]), 
                 .clka(clk), 
                 .clkb(clk), 
                 .dina(XLXN_36[71:0]), 
